...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">State Bank Of India <img src="logos/logo.png" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <strong>Pure Banking, Nothing Else!!!</strong> </h2>
    </class>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="background/2.png" width="600" height="375" class="d-block w-100" alt="...">

            </div>
            <div class="carousel-item">
                <img src="background/SBI.jpg" width="750" height="375" class="d-block w-100" alt="...">
